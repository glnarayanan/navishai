...
class SystemMailConfigurationTest < ActiveSupport::TestCase
  test "distinguishes absent invalid and configured deployment SMTP" do
    ...
    settings = { "NAVISHAI_SYSTEM_SMTP_ADDRESS" => "smtp.test", "NAVISHAI_SYSTEM_SMTP_PORT" => "587", "NAVISHAI_SYSTEM_SMTP_USER_NAME" => "admin", "NAVISHAI_SYSTEM_SMTP_PASSWORD" => "secret" }
