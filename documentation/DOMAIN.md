...
- **Knowledge improvement queue:** one Workspace-scoped, read-only list of knowledge sources that are stale, deleted, retired after confirmed absences, or tied to a failed sync pass. It does not mutate knowledge or send messages.
