...
- **SLA policy:** the active first-response target, resolution target, and warning threshold for one Case priority. A Case snapshots its policy when its SLA starts.
