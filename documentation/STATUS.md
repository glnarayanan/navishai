...
| I5 fresh-host acceptance | External | [INSTALLER_ACCEPTANCE_EVIDENCE.md](./INSTALLER_ACCEPTANCE_EVIDENCE.md) | Requires a clean supported Ubuntu 24.04 and Debian 12 host, the exact candidate, public DNS/ACME, external ingress isolation checks, and an admin who did not build the installer. The 12 September 2026 cloud-agent host recorded these as omitted; nothing here is inferred from mocked tests. |
