class RuntimeInstallationsController < ApplicationController
  ...
  def detect
    ...
    redirect_to workspace_runtime_installations_path(Current.workspace), notice: "Runtime detection finished."
  ...
  def update
    ...
    message = installation.reload.approved? ? "Runtime policy approved." : "Runtime approval revoked."
