class KnowledgeSourceVersion < ApplicationRecord
  ...
  private
    ...
    def url_matches_source
      ...
      errors.add(:retrieved_from_url, "is not allowed for this source") if knowledge_source && !knowledge_source.url? && !knowledge_source.intercom_help_center? && !knowledge_source.notion_page? && retrieved_from_url.present?
    end
end
